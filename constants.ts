import type { Service, NewsArticle, Persona } from './types';
...
export const SERVICES: Service[] = [
  ...
  { id: 'cert-check', title: 'home.services.items.certCheck', icon: CertificateIcon() },
  { id: 'ingredient-validator', title: 'home.services.items.ingredientValidator', icon: CheckIcon() },
  { id: 'marketplace', title: 'home.services.items.marketplace', icon: MarketIcon() },
  { id: 'regulation', title: 'home.services.items.regulation', icon: RegulationIcon() },
  { id: 'supplier-verification', title: 'home.services.items.supplierVerification', icon: SupplierIcon() },
  { id: 'scan-barcode', title: 'home.services.items.scanBarcode', icon: ScanIcon() },
